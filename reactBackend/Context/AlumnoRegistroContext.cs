...
public partial class AlumnoRegistroContext : DbContext
{
    public AlumnoRegistroContext()
    {
    }

    public AlumnoRegistroContext(DbContextOptions<AlumnoRegistroContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source = DESKTOP-EP7G28B\\SQLEXPRESS; Initial Catalog = AlumnoRegistro; User ID = AliciaGuzman; Password=estefany_01; Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FA02DA9DC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FC5B75309");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F7D68ADA5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F991AD008");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7FB5D2E5A");
